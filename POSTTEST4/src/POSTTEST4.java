...
public class POSTTEST4 {
    ...
    public static void hapusData() throws IOException{
        ...
        if(pil == 1){
            if (listKpg.isEmpty()) {
                ...
                if (index < 0 || index >= listKpg.size()) {
                    ...
                    Kopling kopling = listKpg.get(index);
       ...
       public static void PenjelasanMotor() throws IOException {
        ...
        switch (pill) {
            case 1:
                Kopling.deskripsi();
                Kopling.deskripsi(listKpg.size());
                break;
            case 2:
                Matic.deskripsi();
                Matic.deskripsi(listMtc.size());
                break;
            default:
                System.out.println("Input Salah");
                break;
